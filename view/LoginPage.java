...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(null);
        setPreferredSize(new java.awt.Dimension(520, 404));
        ...
        loginResetBtn.setBackground(new java.awt.Color(204, 255, 204));
        loginResetBtn.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        loginResetBtn.setForeground(new java.awt.Color(0, 0, 102));
        loginResetBtn.setText("CLEAR");
        ...
        loginOkBtn.setBackground(new java.awt.Color(204, 255, 204));
        loginOkBtn.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        loginOkBtn.setForeground(new java.awt.Color(0, 0, 102));
        loginOkBtn.setText("ENTER");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(19, 19, 19)
                        .addComponent(loginOkBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(loginResetBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(loginOkBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void loginOkBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginOkBtnActionPerformed
        ...
        if(usernameTxt.getText().isEmpty() || passWordTxt.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Please Enter UserName and PassWord", "Whenever", JOptionPane.INFORMATION_MESSAGE);
        }
        else
        {
            Users user = new Users();
            try{
                boolean isSuccess = user.isLoginOk(usernameTxt.getText(), passWordTxt.getText());
                if(isSuccess){
                    
                    EntryForm fr = new EntryForm();
                    fr.setVisible(true);
